...
cmd({
  ...
  try {
    ...
    const tempFilePath = path.join(os.tmpdir(), `img_grey_${Date.now()}${extension}`);
    ...
    // Convert to greyscale using the API
    ...
    await sendFormattedMessage(
      conn, 
      from, 
      `✅ *Image converted successfully!*\n\n📸 Greyscale effect applied to your image.\n\nEnjoy your edited image!`, 
      sender, 
      pushname,
      "Greyscale - Success",
      "Image delivered"
