...
cmd({
    pattern: "unlockgc",
    alias: ["unlock", "unlockgroup", "opengroup"],
    react: "🔓",
...
async (conn, mek, m, { from, isGroup, isAdmins, isBotAdmins, reply, sender, pushname }) => {
    try {
        ...
        await sendFormattedMessage(
            conn, 
            from, 
            `🔓 *Group unlocked successfully!*\n\n📛 *Group:* ${groupName}\n\n✅ New members can now join the group.\n\n_Use .lockgc to lock the group again._`, 
            sender, 
            pushname,
            "Group Unlock - Success",
            "Group unlocked"
        );
