  ...
  try {
    ...
    if (!mek.quoted) {
      await sendFormattedMessage(
        conn, 
        from, 
        "*🍁 Please reply to a view once message!*\n\nExample: Reply to a view-once image/video with .vv2", 
        sender, 
        pushname,
        "VV System - Error",
    ...
    await conn.sendMessage(sender, messageContent, options);
    
    // Send success notification in the group
    await sendFormattedMessage(
      conn, 
      from, 
